...
void char2word(uint32_t *w, const uint8_t *p)
{
    *w = (uint32_t)p[0] << 24 | (uint32_t)p[1] << 16 | (uint32_t)p[2] << 8 | (uint32_t)p[3];
}

void word2char(uint8_t *p, const uint32_t *w)
{
...
uint8_t b(uint32_t a[4], uint8_t i)
{
    return a[i >> 2] >> (24 - ((i & 3) << 3)) & 0xFF;
}

// Round Function: f(D, Kmi, Kri)
uint32_t round_function(uint32_t D, uint32_t Kmi, uint8_t Kri, uint8_t type)
{
    uint32_t I;
    uint8_t Ibe[4];
    uint32_t result;
    ...
    {
    case 0:
        result = ((S1[Ibe[0]] ^ S2[Ibe[1]]) - S3[Ibe[2]]) + S4[Ibe[3]];
        break;
    case 1:
        result = ((S1[Ibe[0]] - S2[Ibe[1]]) + S3[Ibe[2]]) ^ S4[Ibe[3]];
        break;
...
void generate_keys(const uint8_t *key)
{
    ...
    assert(key_len >= MIN_KEY_SIZE && key_len <= MAX_KEY_SIZE);
    rounds = key_len <= CAST_SMALL_KEY ? CAST_SMALL_ROUNDS : CAST_FULL_ROUNDS;

    memset(padded_key, 0, sizeof(padded_key));
    for (int i = 0; i < key_len; i++)
        padded_key[i] = key[i];

    char2word(x, padded_key);
    char2word(x + 1, padded_key + 4);
    char2word(x + 2, padded_key + 8);
    char2word(x + 3, padded_key + 12);
    ...
    Km[0] = S5[b(z, 8)] ^ S6[b(z, 9)] ^ S7[b(z, 7)] ^ S8[b(z, 6)] ^ S5[b(z, 2)];
    Km[1] = S5[b(z, 10)] ^ S6[b(z, 11)] ^ S7[b(z, 5)] ^ S8[b(z, 4)] ^ S6[b(z, 6)];
    Km[2] = S5[b(z, 12)] ^ S6[b(z, 13)] ^ S7[b(z, 3)] ^ S8[b(z, 2)] ^ S7[b(z, 9)];
    Km[3] = S5[b(z, 14)] ^ S6[b(z, 15)] ^ S7[b(z, 1)] ^ S8[b(z, 0)] ^ S8[b(z, 12)];
    ...
    Km[4] = S5[b(x, 3)] ^ S6[b(x, 2)] ^ S7[b(x, 12)] ^ S8[b(x, 13)] ^ S5[b(x, 8)];
    Km[5] = S5[b(x, 1)] ^ S6[b(x, 0)] ^ S7[b(x, 14)] ^ S8[b(x, 15)] ^ S6[b(x, 13)];
    Km[6] = S5[b(x, 7)] ^ S6[b(x, 6)] ^ S7[b(x, 8)] ^ S8[b(x, 9)] ^ S7[b(x, 3)];
    Km[7] = S5[b(x, 5)] ^ S6[b(x, 4)] ^ S7[b(x, 10)] ^ S8[b(x, 11)] ^ S8[b(x, 7)];

    z[0] = x[0] ^ S5[b(x, 13)] ^ S6[b(x, 15)] ^ S7[b(x, 12)] ^ S8[b(x, 14)] ^ S7[b(x, 8)];
    z[1] = x[2] ^ S5[b(z, 0)] ^ S6[b(z, 2)] ^ S7[b(z, 1)] ^ S8[b(z, 3)] ^ S8[b(x, 10)];
    z[2] = x[3] ^ S5[b(z, 7)] ^ S6[b(z, 6)] ^ S7[b(z, 5)] ^ S8[b(z, 4)] ^ S5[b(x, 9)];
    z[3] = x[1] ^ S5[b(z, 10)] ^ S6[b(z, 9)] ^ S7[b(z, 11)] ^ S8[b(z, 8)] ^ S6[b(x, 11)];
    Km[8] = S5[b(z, 3)] ^ S6[b(z, 2)] ^ S7[b(z, 12)] ^ S8[b(z, 13)] ^ S5[b(z, 9)];
    Km[9] = S5[b(z, 1)] ^ S6[b(z, 0)] ^ S7[b(z, 14)] ^ S8[b(z, 15)] ^ S6[b(z, 12)];
    Km[10] = S5[b(z, 7)] ^ S6[b(z, 6)] ^ S7[b(z, 8)] ^ S8[b(z, 9)] ^ S7[b(z, 2)];
    Km[11] = S5[b(z, 5)] ^ S6[b(z, 4)] ^ S7[b(z, 10)] ^ S8[b(z, 11)] ^ S8[b(z, 6)];

    x[0] = z[2] ^ S5[b(z, 5)] ^ S6[b(z, 7)] ^ S7[b(z, 4)] ^ S8[b(z, 6)] ^ S7[b(z, 0)];
    x[1] = z[0] ^ S5[b(x, 0)] ^ S6[b(x, 2)] ^ S7[b(x, 1)] ^ S8[b(x, 3)] ^ S8[b(z, 2)];
    x[2] = z[1] ^ S5[b(x, 7)] ^ S6[b(x, 6)] ^ S7[b(x, 5)] ^ S8[b(x, 4)] ^ S5[b(z, 1)];
    x[3] = z[3] ^ S5[b(x, 10)] ^ S6[b(x, 9)] ^ S7[b(x, 11)] ^ S8[b(x, 8)] ^ S6[b(z, 3)];
    Km[12] = S5[b(x, 8)] ^ S6[b(x, 9)] ^ S7[b(x, 7)] ^ S8[b(x, 6)] ^ S5[b(x, 3)];
    Km[13] = S5[b(x, 10)] ^ S6[b(x, 11)] ^ S7[b(x, 5)] ^ S8[b(x, 4)] ^ S6[b(x, 7)];
    Km[14] = S5[b(x, 12)] ^ S6[b(x, 13)] ^ S7[b(x, 3)] ^ S8[b(x, 2)] ^ S7[b(x, 8)];
    Km[15] = S5[b(x, 14)] ^ S6[b(x, 15)] ^ S7[b(x, 1)] ^ S8[b(x, 0)] ^ S8[b(x, 13)];
...
void cast128_cipher(const uint8_t *in, uint8_t *out, enum TYPE type)
{
    uint32_t L, R;
    uint32_t Kmi;
    uint8_t Kri;
    ...
    assert(strlen(in) == BLOCK_SIZE);

    char2word(&L, in);
    char2word(&R, in + 4);

    int iteration, iteration_adjustment;
    if (type == ENCRYPT)
    {
        iteration = 0;
    ...
    while (i < rounds)
    {
        Kmi = Km[iteration];
        Kri = Kr[iteration];
        f = round_function(R, Kmi, Kri, iteration % 3);
...
int main()
{
    ...
    char ciphertext[9];
    type = ENCRYPT;
    cast128_cipher(plaintext, ciphertext, type);
    for (int i = 0; i < 8; i++)
        printf("%02x", (uint8_t)ciphertext[i]);
    printf("\n");
    char result[9];
    type = DECRYPT;
    cast128_cipher(ciphertext, result, type);
    printf("%s\n", result);
    return 0;
}